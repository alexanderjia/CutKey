...
public class ModelMachiningSerial implements IModelMachiningSerial
{
	...
	{
		// TODO Auto-generated method stub
		return MachiningDatas.getMatchSerial(data, true);
	}
	...
	{
		// TODO Auto-generated method stub
		return CutClient.IsSerialExist(serial, indexId);
	}

	@Override
	public KeyShapeDatas getKeyShapePointsData(int indexId, String serial)
	{
		// TODO Auto-generated method stub		
		return KeyShapePoints.getKeyShapePoints(indexId, serial, true);
	}
